								...
								<div class="col-sm-4">
									<div class="single-item">
										<div class="single-item-header">
											<a href="chi-tiet-san-pham/{{$sp->id}}"><img src="source/image/product/{{$sp->image}}" alt=""height="200" width="250"/></a>
										</div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="single-item">
										<div class="single-item-header">
											<a href="chi-tiet-san-pham/{{$sp_k->id}}"><img src="source/image/product/{{$sp_k->image}}" alt=""height="200" width="250"/></a>
										</div>
										<div class="single-item-body">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="add-to-cart/{{$sp_k->id}}"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="chi-tiet-san-pham/{{$sp_k->id}}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
